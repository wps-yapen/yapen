...
class Pension(models.Model):
    ...
    room_num = models.CharField(max_length=100,blank=True)# '객실 수'  # 해커톤때 room
...
class Room(models.Model):
    ...
    number_of_people = models.CharField(max_length=100,blank=True) # '인원'
    price = models.CharField( max_length=100,blank=True) # '가격'


class PensionImage(models.Model):
    pension_id = models.ForeignKey(
        Room,
